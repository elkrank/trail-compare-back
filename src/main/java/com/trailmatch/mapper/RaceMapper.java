...
public class RaceMapper {
    ...
    public RaceResponse toResponse(Race r){ return new RaceResponse(r.getId(), r.getName(), r.getLocation(), r.getRegion(), r.getDate(), r.getDistanceKm(), r.getElevationGainM(), r.getTerrainType(), r.getTechnicalityLevel(), r.getCutoffTimeMinutes(), r.getLastFinisherTimeMinutes(), r.getMedianFinisherTimeMinutes(), r.getAidStationsCount(), r.getPriceEur(), r.getDescription(), r.getTags(), r.getSourceUrl(), r.getCreatedAt(), r.getUpdatedAt(), metricsService.elevationPerKm(r), metricsService.cutoffPace(r), metricsService.lastFinisherPace(r), metricsService.medianPace(r), difficultyScoringService.score(r)); }
}
